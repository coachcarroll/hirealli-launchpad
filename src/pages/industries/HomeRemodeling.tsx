          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Win <span className="text-primary">$50K+ Projects</span> Consistently
              </h1>
              
              <p className="text-xl text-muted-foreground mb-8">
                Remodeling contractors using Alli generate 122 leads in 6 months with a 70% close rate. Showcase your craftsmanship and fill your pipeline.
              </p>
